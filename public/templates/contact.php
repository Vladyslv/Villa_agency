    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <p>Máte záujem o niektorú z našich nehnuteľností? Napíšte nám správu cez formulár a my sa vám ozveme čo najskôr.</p>
          <div class="row">
            <div class="col-lg-12">
        ...
        <div class="col-lg-6">
          ...
          <?php if ($error): ?>
            <div style="background:#f8d7da; color:#721c24; padding:14px; border-radius:8px; margin-bottom:20px;">
              Vyplňte prosím všetky povinné polia a uveďte platný email.
            </div>
          <?php endif; ?>
